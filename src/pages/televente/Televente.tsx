...
import TeleventeForm from "../../components/forms/TeleventeForm";
...
export default function TeleventePage() {
  ...
  const [subSection, setSubSection] = useState<"form" | "ventes" | "succes">(
    "form"
  );
  ...
  return (
    <div className="p-8 min-h-screen bg-gray-100 dark:bg-zinc-900 text-zinc-800 dark:text-white">
      ...
      <div className="flex justify-center">
        {subSection === "form" && employeeId !== undefined && (
          <TeleventeForm employeeId={employeeId} />
        )}
        {subSection === "ventes" && employeeId !== undefined && (
          <MesVentes employeeId={employeeId} />
        )}
        {subSection === "succes" && employeeId !== undefined && (
          <Succes employeeId={employeeId} />
        )}
      </div>
    </div>
  );
